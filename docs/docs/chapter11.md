...
description: "Explore emerging trends and the future direction of data engineering, from simplified tools to the live data stack"
---
...
1. [The Data Engineering Lifecycle Isn't Going Away](#the-data-engineering-lifecycle-isnt-going-away)
2. [The Decline of Complexity and the Rise of Easy-to-Use Data Tools](#the-decline-of-complexity-and-the-rise-of-easy-to-use-data-tools)
3. [The Cloud-Scale Data OS and Improved Interoperability](#the-cloud-scale-data-os-and-improved-interoperability)
4. ["Enterprisey" Data Engineering](#enterprisey-data-engineering)
5. [Titles and Responsibilities Will Morph](#titles-and-responsibilities-will-morph)
6. [Moving Beyond the Modern Data Stack, Toward the Live Data Stack](#moving-beyond-the-modern-data-stack-toward-the-live-data-stack)
   - The Live Data Stack
...
7. [Dark Matter Data and the Rise of...Spreadsheets?!](#dark-matter-data-and-the-rise-ofspreadsheets)

## The Data Engineering Lifecycle Isn't Going Away

**In plain English:** Just like construction still needs foundations, walls, and roofs despite new tools, data engineering will always need generation, storage, ingestion, transformation, and servingeven as the tools evolve.

**In technical terms:** The data engineering lifecycle represents fundamental stages of data flow that transcend specific technologies, providing a durable framework as tooling continues to simplify and mature.

**Why it matters:** While tools change constantly, understanding the lifecycle stages helps you stay relevant as you move up the value chain to focus on higher-level problems rather than low-level implementation details.
...
> **Insight**
>
> As organizations leverage data in new ways, data engineers will move up the value chain to focus on higher-level work. The data engineering lifecycle isn't going away anytime soon.

## The Decline of Complexity and the Rise of Easy-to-Use Data Tools

**In plain English:** Data engineering used to require a PhD and a massive team. Now, a small team can do what only tech giants could do a decade ago, thanks to managed services and simplified tools.

**In technical terms:** The evolution from self-managed distributed systems to cloud-managed services has abstracted away operational complexity, democratizing access to previously enterprise-only capabilities.

**Why it matters:** Lower barriers to entry mean more companies can leverage data effectively, and data engineers can focus on business value rather than managing infrastructure.

Simplified, easy-to-use tools continue to lower the barrier to entry for data engineering. This is a great thing, especially given the shortage of data engineers we've discussed. The trend toward simplicity will continue. Data engineering isn't dependent on a particular technology or data size. It's also not just for large companies. In the 2000s, deploying "big data" technologies required a large team and deep pockets. The ascendance of SaaS-managed services has largely removed the complexity of understanding the guts of various "big data" systems. Data engineering is now something that all companies can do.
...
<ComparisonTable
  title="Evolution of Data Engineering Complexity"
  headers={["Era", "Approach", "Characteristics"]}
  rows={[
    ["2000s", "Self-managed big data", "Required large teams, deep technical expertise, expensive infrastructure"],
    ["2010s", "Cloud migration", "Managed services emerge, operational complexity reduces, costs become variable"],
    ["2020s+", "Simplified abstraction", "Off-the-shelf connectors, no-code/low-code tools, focus on business value"]
  ]}
/>
...
**In plain English:** Just like your phone's operating system provides standard ways for apps to work together, the cloud is developing standard ways for data services to work together seamlessly.

**In technical terms:** Cloud data platforms are evolving toward standardized APIs, metadata catalogs, and interoperability standards that enable automated orchestration and integration across heterogeneous services.

**Why it matters:** Better interoperability means less custom integration work, more automation, and the ability to compose best-of-breed services without complex glue code.
...
<DiagramContainer title="Cloud Data OS Concept">
  <StackDiagram>
    <Box color={colors.purple}>Data Applications & Workflows</Box>
    <Box color={colors.green}>Standard Data APIs & Metadata Catalog</Box>
    <Box color={colors.blue}>Cloud Data Services (Storage, Compute, Streaming)</Box>
    <Box color={colors.gray}>Cloud Infrastructure (Networking, Servers, Disks)</Box>
  </StackDiagram>
</DiagramContainer>
...
> **Insight**
>
> What does this enhanced abstraction mean for data engineers? The role won't go away, but it will evolve significantly. Data engineers will focus on building better-quality, more sophisticated applications.
...
**In plain English:** "Enterprise" used to mean slow, bureaucratic, and boring. But the good partsgovernance, standards, and reliabilityare becoming accessible to companies of all sizes.

**In technical terms:** Data management practices once limited to large organizations (governance frameworks, DataOps, observability) are becoming standardized and accessible through modern tooling.

**Why it matters:** As data engineering matures, the "boring" practices of governance and operations become differentiators. Companies that get this right will have more reliable, trustworthy data systems.

The increasing simplification of data tools and the emergence and documentation of best practices means data engineering will become more "enterprisey." This will make many readers violently cringe. The term enterprise, for some, conjures Kafkaesque nightmares of faceless committees dressed in overly starched blue shirts and khakis, endless red tape, and waterfall-managed development projects with constantly slipping schedules and ballooning budgets. In short, some of you read "enterprise" and imagine a soulless place where innovation goes to die.
...
**In plain English:** The lines between data engineer, data scientist, ML engineer, and software engineer are blurringexpect new hybrid roles to emerge.

**In technical terms:** As tooling simplifies and data becomes embedded in applications, new roles will emerge at the intersections: ML-focused engineers bridging data and ML operations, and application engineers with deep data expertise.

**Why it matters:** Understanding that roles are fluid helps you stay adaptable. The most valuable professionals will have T-shaped skillsdeep expertise in one area with broad understanding across adjacent domains.
...
<DiagramContainer title="Evolving Roles">
  <Row>
    <Column>
      <Box color={colors.blue}>Traditional Data Engineer</Box>
      <Box color={colors.gray}>Server management, pipelines</Box>
    </Column>
    <Column>
      <Box color={colors.green}>Future Data Engineer</Box>
      <Box color={colors.gray}>Architecture, governance, DataOps</Box>
    </Column>
  </Row>
  <Row>
    <Column>
      <Box color={colors.blue}>Traditional Data Scientist</Box>
      <Box color={colors.gray}>Data munging, exploration, modeling</Box>
    </Column>
    <Column>
      <Box color={colors.green}>Future Data Scientist</Box>
      <Box color={colors.gray}>Advanced analysis, research models</Box>
    </Column>
  </Row>
  <Row>
    <Column span={2}>
      <Box color={colors.purple}>New: ML Operations Engineer</Box>
      <Box color={colors.gray}>Model deployment, monitoring, automated training</Box>
    </Column>
  </Row>
</DiagramContainer>
...
**In plain English:** The modern data stack is based on batch processing and data warehousesyesterday's data. The future is real-time, where data flows continuously and applications respond instantly.

**In technical terms:** The live data stack replaces batch-oriented ELT with streaming pipelines and real-time OLAP databases, enabling subsecond analytics and automated decision-making integrated directly into applications.

**Why it matters:** Real-time data applications create fundamentally better user experiences and enable automation that batch systems can't support. This is the next paradigm shift in data engineering.
...
**In plain English:** The live data stack is like the nervous system of a modern appdata flows continuously, insights are generated in real time, and actions happen automatically without human intervention.

**In technical terms:** The live data stack integrates streaming pipelines, real-time OLAP databases, and ML systems with applications, enabling continuous data flow from source systems through processing and back to applications with subsecond latency.

**Why it matters:** This architectural shift enables entirely new classes of applications and user experiences that weren't possible with batch-oriented architectures.

This democratization of real-time technologies will lead us to the successor to the MDS: the live data stack will soon be accessible and pervasive. The live data stack will fuse real-time analytics and ML into applications by using streaming technologies, covering the full data lifecycle from application source systems to data processing to ML, and back.

<DiagramContainer title="In the live data stack, data and intelligence moves in real time between the application and supporting systems">
  <ProcessFlow direction="circular">
    <Box color={colors.blue}>Application</Box>
    <Arrow label="Events" />
    <Box color={colors.green}>Streaming Pipeline</Box>
    <Arrow label="Processed Data" />
    <Box color={colors.purple}>Real-Time OLAP DB</Box>
    <Arrow label="Analytics & ML" />
    <Box color={colors.orange}>Intelligent Actions</Box>
    <Arrow label="Back to App" />
  </ProcessFlow>
</DiagramContainer>
...
**In plain English:** Instead of collecting data in batches like taking snapshots every hour, streaming treats data like a continuous video feed that's always on.

**In technical terms:** Streaming pipelines process unbounded data streams continuously, while real-time analytical databases enable subsecond query performance on freshly ingested data, combining the best of OLTP and OLAP.

**Why it matters:** Batch processing creates artificial delays in data pipelines. Streaming eliminates these bottlenecks, enabling truly real-time analytics and automated decision-making.
...
> **Insight**
>
> In conjunction with the rise of streams, we expect a back-to-the-future moment for data transformations. We'll shift away from ELTin database transformationsto something that looks more like ETL. We provisionally refer to this as stream, transform, and load (STL).
...
<ComparisonTable
  title="Modern Data Stack vs Live Data Stack"
  headers={["Aspect", "Modern Data Stack", "Live Data Stack"]}
  rows={[
    ["Data Flow", "Batch (ELT)", "Streaming (STL)"],
    ["Latency", "Minutes to hours", "Subseconds"],
    ["Primary Use Case", "Internal analytics & BI", "Real-time applications & automation"],
    ["Architecture", "Data warehouse-centric", "Streaming pipeline + real-time OLAP"],
    ["Transformation", "In-database (dbt, SQL)", "In-stream + in-database"]
  ]}
/>

### The Fusion of Data with Applications

**In plain English:** In the future, there won't be a separate "data stack" and "application stack"they'll be one integrated system where data flows seamlessly between them.

**In technical terms:** Application layers will integrate streaming pipelines and real-time ML directly, with feature stores and hybrid OLTP/OLAP databases bridging transactional and analytical workloads in unified architectures.

**Why it matters:** The artificial separation between applications and data creates friction and delays. Fusing them enables intelligent applications that adapt in real time to changing data.
...
**In plain English:** In the future, apps won't just use ML modelsthey'll continuously learn from user interactions and improve themselves in real time, like a conversation that gets smarter as it goes.

**In technical terms:** Tight feedback loops enable online learning where models are continuously trained on streaming data, with predictions fed back into applications and user responses immediately used to update models.

**Why it matters:** This creates self-improving systems that adapt to changing conditions without manual intervention, delivering increasingly personalized and effective user experiences.
...
<DiagramContainer title="Tight Feedback Loop: Applications and ML">
  <ProcessFlow direction="circular">
    <Box color={colors.blue}>User Interaction</Box>
    <Arrow />
    <Box color={colors.green}>Application</Box>
    <Arrow />
    <Box color={colors.purple}>ML Model Prediction</Box>
    <Arrow />
    <Box color={colors.orange}>User Response</Box>
    <Arrow />
    <Box color={colors.red}>Model Update</Box>
    <Arrow />
  </ProcessFlow>
</DiagramContainer>
...
**In plain English:** Spreadsheets are the most widely used data tool on Earth, yet data engineers largely ignore them. The future might bring spreadsheet-like ease of use to cloud-scale databases.

**In technical terms:** Spreadsheets provide interactive, programmable analytics accessible to a billion users, suggesting a product opportunity for tools that combine spreadsheet-like UX with backend power of cloud OLAP systems.

**Why it matters:** If data engineering ignores how most people actually work with data, we're building for the few instead of the many. The next breakthrough might combine the best of both worlds.
...
> **Insight**
>
> We predict that a new class of tools will emerge that combines the interactive analytics capabilities of a spreadsheet with the backend power of cloud OLAP systems.
...
<DiagramContainer title="The Future of Data Engineering">
  <TreeDiagram>
    <Box color={colors.blue}>Simplified Tools & Lower Barriers</Box>
    <Box color={colors.green}>Cloud-Scale Data OS & Interoperability</Box>
    <Box color={colors.purple}>Live Data Stack & Real-Time Applications</Box>
    <Box color={colors.orange}>Fusion of Applications, Data, and ML</Box>
  </TreeDiagram>
</DiagramContainer>
...
> **Insight**
>
> Data engineering is a vast topic. We hope we have succeeded in creating a kind of travel guide that will help current and future data engineers find their way in a domain that is in flux.
...
> **Final Thought**
>
> Technology trends are defined not only by those who create the underlying technology but also by those who adopt it and put it to good use. You play a role in determining what comes next.

---

**Previous:** [Chapter 10: Security and Privacy](./chapter10.md) | **Next:** Appendix A: Serialization and Compression Technical Details
